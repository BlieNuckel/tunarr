...
import { getHistorySlots } from "./history";
...
describe("getHistorySlots", () => {
  it("returns completed downloads as history slots", async () => {
    ...
    expect(slots[0].storage).toBe("/downloads/complete/Test Album");
  });

  it("excludes in-progress downloads", async () => {
    mockGetAllDownloads.mockReturnValue([
      {
        nzoId: "nzo1",
        title: "Test Album",
