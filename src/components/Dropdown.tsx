...
export default function Dropdown({
  ...
  const triggerClasses =
    "w-full sm:w-sm px-3 py-2 bg-white dark:bg-gray-800 border-2 border-black rounded-lg text-base sm:text-sm text-left shadow-cartoon-md focus:outline-none focus:border-amber-400";
